...
@interface IDMPhotoBrowser () {
	...
	// Toolbar
	UIToolbar *_toolbar;
	UIBarButtonItem *_previousButton, *_nextButton, *_actionButton, *_actionDeleteButton, *_actionCustomButton;
...
- (void)viewDidLoad {
    ...
    _actionDeleteButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemTrash
                                                                        target:self
...
- (void)performLayout {
    ...
    if(self.customButtonImage != NULL) {
        [items addObject:_actionCustomButton];
    }
    if(self.displayDeleteButton) {
        [items addObject:_actionDeleteButton];
    }
